...
import type { SummaryService, SummaryGenerationOptions } from "@/types/summary";
...
describe("SummaryService", () => {
  ...
  describe("createSummaryService factory", () => {
    it("should create mock service when useMock is true", async () => {
      const service = await createSummaryService(true);
    ...
    it("should create mock service when no API key and in development", async () => {
    ...
    it("should throw error when no API key and not using mock", async () => {
      await expect(() => {
        createSummaryService(true);
      }).toThrow("OpenAI API key is required");
    });

    it("should create OpenAI service with valid API key", async () => {
      const service = await createSummaryService(true);
  ...
  describe("MockSummaryService", () => {
    ...
    beforeEach(async () => {
      service = await createSummaryService(true);
    });
  ...
  describe("createDefaultSummaryService", () => {
    it("should create service based on environment configuration", async () => {
      const service = await createSummaryService(true);
